...
goog.addDependency("../transmorphic/utils.js", ['transmorphic.utils'], ['cljs.core']);
goog.addDependency("../transmorphic/event.js", ['transmorphic.event'], ['transmorphic.utils', 'cljs.core']);
goog.addDependency("../transmorphic/manipulation.js", ['transmorphic.manipulation'], ['cljs.core']);
...
goog.addDependency("../transmorphic/repl.js", ['transmorphic.repl'], ['goog.net.XhrIo', 'cljs.tools.reader', 'goog.string', 'cljs.js', 'cljs.core', 'cljs.tools.reader.reader_types', 'cljs.core.async', 'goog.events.EventType', 'cljs.pprint', 'clojure.string', 'cljs.reader']);
...
goog.addDependency("../transmorphic/globals.js", ['transmorphic.globals'], ['cljs.core']);
goog.addDependency("../transmorphic/symbolic.js", ['transmorphic.symbolic'], ['clojure.zip', 'cljs.tools.reader', 'clojure.core.reducers', 'cljs.core', 'cljs.pprint', 'cljs.analyzer', 'clojure.string', 'transmorphic.globals']);
goog.addDependency("../transmorphic/core.js", ['transmorphic.core'], ['transmorphic.event', 'goog.dom', 'cljs.core', 'om.dom', 'clojure.set', 'om.core', 'devtools.core', 'clojure.string', 'transmorphic.repl', 'transmorphic.symbolic']);
...
goog.addDependency("../transmorphic/morph.js", ['transmorphic.morph'], ['transmorphic.manipulation', 'goog.dom', 'transmorphic.utils', 'cljs.core', 'transmorphic.core', 'om.next', 'transmorphic.repl', 'transmorphic.symbolic']);
goog.addDependency("../transmorphic/tools/hand.js", ['transmorphic.tools.hand'], ['transmorphic.event', 'transmorphic.utils', 'cljs.core', 'transmorphic.core', 'om.next', 'transmorphic.morph', 'transmorphic.symbolic']);
goog.addDependency("../transmorphic/tools/window.js", ['transmorphic.tools.window'], ['transmorphic.event', 'transmorphic.utils', 'cljs.core', 'om.dom', 'transmorphic.tools.hand', 'transmorphic.core', 'transmorphic.morph']);
goog.addDependency("../transmorphic/tools/ace.js", ['transmorphic.tools.ace'], ['transmorphic.utils', 'cljs.core', 'transmorphic.tools.window', 'om.dom', 'transmorphic.core', 'transmorphic.repl', 'cljs.reader', 'transmorphic.morph', 'transmorphic.symbolic']);
goog.addDependency("../transmorphic/tools/function_inspector.js", ['transmorphic.tools.function_inspector'], ['transmorphic.event', 'transmorphic.manipulation', 'transmorphic.utils', 'cljs.core', 'transmorphic.tools.window', 'cljs.core.async', 'cljs.pprint', 'transmorphic.core', 'clojure.string', 'transmorphic.repl', 'transmorphic.tools.ace', 'transmorphic.morph', 'transmorphic.symbolic']);
goog.addDependency("../transmorphic/tools/halo.js", ['transmorphic.tools.halo'], ['transmorphic.event', 'transmorphic.utils', 'cljs.core', 'transmorphic.tools.hand', 'transmorphic.core', 'transmorphic.tools.function_inspector', 'transmorphic.morph']);
goog.addDependency("../transmorphic/tools/function_editor.js", ['transmorphic.tools.function_editor'], ['cljs.core', 'transmorphic.tools.window', 'cljs.pprint', 'transmorphic.core', 'clojure.string', 'transmorphic.repl', 'transmorphic.tools.ace', 'cljs.reader', 'transmorphic.morph', 'transmorphic.symbolic']);
goog.addDependency("../transmorphic/tools/world.js", ['transmorphic.tools.world'], ['transmorphic.event', 'transmorphic.tools.halo', 'transmorphic.utils', 'cljs.core', 'transmorphic.tools.window', 'transmorphic.tools.hand', 'transmorphic.core', 'om.next', 'transmorphic.morph', 'transmorphic.tools.function_editor']);
goog.addDependency("../examples/playground.js", ['examples.playground'], ['transmorphic.event', 'transmorphic.manipulation', 'goog.dom', 'transmorphic.utils', 'cljs.core', 'transmorphic.tools.window', 'transmorphic.tools.hand', 'transmorphic.tools.world', 'transmorphic.core', 'om.next', 'transmorphic.repl', 'transmorphic.tools.ace', 'transmorphic.morph', 'transmorphic.tools.function_editor', 'transmorphic.symbolic']);
...
goog.addDependency("../figwheel/connect.js", ['figwheel.connect'], ['examples.playground', 'cljs.core', 'figwheel.client', 'transmorphic.core', 'figwheel.client.utils']);
...
goog.addDependency("../examples/lol.js", ['examples.lol'], ['cljs.core']);
