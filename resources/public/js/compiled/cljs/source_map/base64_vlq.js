...
var digit_19140 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_19141__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_19141__$1 > (0))){
var digit_19142__$1 = (digit_19140 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_19142__$1));

var G__19143 = (vlq_19141__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__19144 = (vlq_19141__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_19140 = G__19143;
vlq_19141__$1 = G__19144;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_19140));
}
break;
}
...
var G__19145 = i__$1;
var G__19146 = result__$1;
var G__19147 = shift__$1;
i = G__19145;
result = G__19146;
shift = G__19147;
continue;
