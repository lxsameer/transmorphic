...
var seq__27482_27486 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__27483_27487 = null;
var count__27484_27488 = (0);
var i__27485_27489 = (0);
while(true){
if((i__27485_27489 < count__27484_27488)){
var str_27490 = cljs.core._nth.call(null,chunk__27483_27487,i__27485_27489);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),str_27490);

var G__27491 = seq__27482_27486;
var G__27492 = chunk__27483_27487;
var G__27493 = count__27484_27488;
var G__27494 = (i__27485_27489 + (1));
seq__27482_27486 = G__27491;
chunk__27483_27487 = G__27492;
count__27484_27488 = G__27493;
i__27485_27489 = G__27494;
continue;
} else {
var temp__4425__auto___27495 = cljs.core.seq.call(null,seq__27482_27486);
if(temp__4425__auto___27495){
var seq__27482_27496__$1 = temp__4425__auto___27495;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__27482_27496__$1)){
var c__17628__auto___27497 = cljs.core.chunk_first.call(null,seq__27482_27496__$1);
var G__27498 = cljs.core.chunk_rest.call(null,seq__27482_27496__$1);
var G__27499 = c__17628__auto___27497;
var G__27500 = cljs.core.count.call(null,c__17628__auto___27497);
var G__27501 = (0);
seq__27482_27486 = G__27498;
chunk__27483_27487 = G__27499;
count__27484_27488 = G__27500;
i__27485_27489 = G__27501;
continue;
} else {
var str_27502 = cljs.core.first.call(null,seq__27482_27496__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),str_27502);

var G__27503 = cljs.core.next.call(null,seq__27482_27496__$1);
var G__27504 = null;
var G__27505 = (0);
var G__27506 = (0);
...
var args27509 = [];
var len__17883__auto___27512 = arguments.length;
var i__17884__auto___27513 = (0);
while(true){
if((i__17884__auto___27513 < len__17883__auto___27512)){
args27509.push((arguments[i__17884__auto___27513]));

var G__27514 = (i__17884__auto___27513 + (1));
i__17884__auto___27513 = G__27514;
continue;
} else {
}
break;
...
return (function (){
if(cljs.core.truth_((function (){var and__16813__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__27519 = script;
goog.object.set(G__27519,"type","text/javascript");

goog.object.set(G__27519,"onload",onload);

goog.object.set(G__27519,"onreadystatechange",onload);

return G__27519;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__27520 = script__$1;
goog.object.set(G__27520,"src",src);

return G__27520;
})():(function (){var G__27521 = script__$1;
goog.dom.setTextContext(G__27521,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__16825__auto__ = reload;
...
var path_27522 = (goog.dependencies_.nameToPath[src]);
goog.object.remove(goog.dependencies_.visited,path_27522);

goog.object.remove(goog.dependencies_.written,path_27522);

goog.object.remove(goog.dependencies_.written,[cljs.core.str(goog.basePath),cljs.core.str(path_27522)].join(''));
} else {
}
